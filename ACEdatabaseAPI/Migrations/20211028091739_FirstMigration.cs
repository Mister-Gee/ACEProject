        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormerName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    NIN = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: true),
                    JambRegNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MatricNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StaffID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AdmissionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModeOfAdmission = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StudentCategory = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Programme = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EntryLevel = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CurrentLevel = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    School = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Department = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MaritalStatus = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    LG = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    RolesCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
