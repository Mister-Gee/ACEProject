...
namespace ACE.Domain.Migrations
{
    ...
    [Migration("20211227190256_updateModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ACE.Domain.Entities.Course", b =>
                {
                    ...
                    b.Property<string>("OtherCourseLecturer")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ACE.Domain.Entities.CurrentAcademicSession", b =>
                {
                    ...
                    b.ToTable("CurrentAcademicSession");
                });
            ...
            modelBuilder.Entity("ACE.Domain.Entities.ClassAttendance", b =>
                {
                    b.HasOne("ACE.Domain.Entities.ControlledEntities.AcademicYear", "AcademicYear")
                        .WithMany()
                        .HasForeignKey("AcademicYearID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ACE.Domain.Entities.Course", "Course")
                        .WithMany()
                        .HasForeignKey("CourseID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ACE.Domain.Entities.ControlledEntities.Semester", "Semester")
                        .WithMany()
            ...
            modelBuilder.Entity("ACE.Domain.Entities.ExamRecords", b =>
                {
                    ...
                    b.HasOne("ACE.Domain.Entities.ControlledEntities.Department", "Department")
                        .WithMany()
